        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Row(children: const [Text('Dashboard', style: TextStyle(color: Colors.grey)), SizedBox(width: 8), Icon(Icons.chevron_right, size: 16), SizedBox(width: 8), Text('All Products', style: TextStyle(fontWeight: FontWeight.bold))]),
