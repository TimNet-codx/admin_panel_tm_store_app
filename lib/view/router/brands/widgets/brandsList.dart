...
import 'package:admin_panel_tm_store_app/view/router/brands/widgets/createBrand.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Row(children: const [Text('Dashboard', style: TextStyle(color: Colors.grey)), SizedBox(width: 8), Icon(Icons.chevron_right, size: 16), SizedBox(width: 8), Text('All Brands', style: TextStyle(fontWeight: FontWeight.bold))]),
          ...
          SizedBox(
            ...
            Container(
              ...
              child: FutureBuilder<List<BrandMode>>(
                      ...
                      child: DataTable(
                        ...
                        rows: List.generate(brands.length, (index) {
                          ...
                          return DataRow(cells: [
                            ...
                            DataCell(Text(brand.id)), // replace when API supports it// replace when API supports it                        
                            // brand image + title
                               DataCell(Row(
                              children: [
                                ClipRRect(
                            ...
                            DataCell(Text(brand.categoryName),),
                            ...
                            DataCell(Text(TFormatter.formatDate (brand.createdAt))),
                            DataCell(Row(
                              children: [
                                IconButton(
                                  onPressed: () {},
